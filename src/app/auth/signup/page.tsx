...
import { signupWithEmail } from "@/actions/auth/signup"; // Adjust path as needed
...
export default function Login() {
  ...
  return (
    <div className="flex justify-center items-center h-[100vh]">
      <div className="bg-white flex flex-col items-center min-w-xl mx-auto border-1 border-gray-300 rounded-lg">
